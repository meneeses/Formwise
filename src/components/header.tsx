...
const NAV = [
  ...
  { href: "/precos", label: "Preços & Licenças" },
  { href: "/faq", label: "FAQ" },
          ...
          {NAV.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={`${linkBase} ${
                  active ? "opacity-100 after:w-full" : ""
                }`}
              >
                {item.label}
              </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="
              ...
              active:scale-[.98] transition-colors duration-300
            "
        ...
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 py-4 transition-colors duration-300">
          <ul className="grid gap-2">
            {NAV.map((item) => {
              ...
              `}
                  >
                    {/* sublinhado só do tamanho da palavra */}
                    <span
                      className={`
                  relative inline-block
                  ${
                    active
                      ? "after:absolute after:left-0 after:right-0 after:-bottom-1 after:h-[2px] after:bg-[rgb(var(--accent))]"
                      : ""
                  }
                `}
                    >
